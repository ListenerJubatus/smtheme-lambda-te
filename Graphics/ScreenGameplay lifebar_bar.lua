...
t[#t+1] = Def.ActorFrame {
	...
	Def.Quad {
		...
		--
		HotCommand=cmd(diffuse,color("#FFB45E");diffuseshift;effectclock,'beat';effectcolor1,color("#FFB45E");effectcolor2,color("#ED5421");),
