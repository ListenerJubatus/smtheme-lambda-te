...
local t = Def.ActorFrame {
	Def.ActorFrame {
	OnCommand=cmd(zoomy,0.7;diffusealpha,0;sleep,0.3;decelerate,0.3;diffusealpha,1;zoomy,1;);
	OffCommand=cmd(decelerate,0.3;diffusealpha,0;zoomy,0.7;);
	LoadFont("Common Condensed") .. {
		Text=ToEnumShortString(PlayerNumber);
		Name="PlayerShortName",
		InitCommand=cmd(x,-102;zoom,0.75),
