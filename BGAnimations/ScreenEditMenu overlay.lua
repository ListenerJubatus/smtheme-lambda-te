local steps_item_space= _screen.h*.07
...
local stype_item_mt= edit_pick_menu_steps_display_item(
	stype_transform, Def.BitmapText{
		Font= "Common Normal", InitCommand= function(self)
			self:zoom(.5):horizalign(left):diffuse(color("#CEE5ED")):strokecolor(color("#000000"))
		end,
	...
	steps_transform, Def.BitmapText{
		...
		SetCommand= function(self, param)
			...
			width_limit_text(self, steps_item_width, 0.75)
		end,
})
...
local menu_params= {
	name= "menu", x= _screen.cx*.47, y= 80, width= _screen.cx-100,
	...
	num_displays= 1, el_height= 24, display_params= {
		no_status= true,
		height= _screen.h-111, el_zoom= .75,
		heading_height= 12,
		on= function(self)
		...
		item_mt= cons_option_item_mt, item_params= {
			text_commands= {
				Font= "Common Normal", OnCommand= function(self)
					self:diffuse(color("#CEE5ED")):diffusealpha(0):decelerate(0.2):diffusealpha(1)
				end,
...
local frame= Def.ActorFrame{
	...
	Def.BitmapText{
		Name= "length", Font= "Common Normal", InitCommand= function(self)
			self:xy(length_x, length_y):horizalign(right):zoom(.75):diffuse(color("#CEE5ED")):strokecolor(color("#000000"))
		end,
		edit_menu_selection_changedMessageCommand= function(self, params)
			if params.group then
				self:visible(false)
	...
	Def.BitmapText{
		Name= "bpm", Font= "Common Normal", InitCommand= function(self)
			self:xy(bpm_x, bpm_y):horizalign(right):zoom(.5):diffuse(color("#CEE5ED")):strokecolor(color("#000000"))
		end,
		edit_menu_selection_changedMessageCommand= function(self, params)
			if params.group then
				self:visible(false)
	...
	Def.BitmapText{
 		Name= "title", Font= "Common Normal", InitCommand= function(self)
			self:xy(title_x, title_y):horizalign(left):zoom(.75):diffuse(color("#CEE5ED")):strokecolor(color("#000000"))
		end,
		edit_menu_selection_changedMessageCommand= function(self, params)
			if params.group then
				self:visible(false)
	...
	Def.BitmapText{
 		Name= "artist", Font= "Common Normal", InitCommand= function(self)
			self:xy(artist_x, artist_y):horizalign(left):zoom(.5):diffuse(color("#CEE5ED")):strokecolor(color("#000000"))
		end,
		edit_menu_selection_changedMessageCommand= function(self, params)
			if params.group then
				self:visible(false)
